"""
Django settings for cardioweb project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-g5mrknmp#)w)y#2afh27o015xwcovclyo8wb^^b5l@yk8h&v=z')
# SECRET_KEY = 'django-insecure-g5mrknmp#)w)y#2afh27o015xwcovclyo8wb^^b5l@yk8h&v=z'
